...
import AddTermsModal from './Modals/AddTermsModal';
import EditTermsModal from './Modals/EditTermsModal';
...
const Terms = ({ notify }) => {
      ...
      selector: row => <div className="flex justify-center">
        ...
        {/* <div onClick={async () => {
          if (row.status === "true") {
            ...
            let ans = await undoTerms({ id: row._id });
            if (ans.status) {
              notify('success', 'Terms recovered successfully');
  ...
  //   console.log(id);
  //   const ans = await deleteTerms(id);
  ...
  return (
    <>
      <AddTermsModal setRefreshFlag={setRefreshFlag} refreshFlag={refreshFlag} notify={notify} />
      <EditTermsModal flag={flag} data={data1} setRefreshFlag={setRefreshFlag} refreshFlag={refreshFlag} notify={notify} />
            ...
            <div className="flex items-center justify-between">
              ...
              {data.length > 0 ? <Button color="red" onClick={() => {
                ...
                Edit</Button> : <Button color="red" onClick={() => {
                  document.getElementById('addTermsModal').classList.toggle('hidden');
