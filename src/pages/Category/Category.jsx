...
const Category = ({ notify }) => {
  ...
  const columns = [
    ...
    },
    {
      name: 'Title',
      selector: (row) => (
        <Link to={`/dashboard/contests-categories/${row.title}/${row._id}`}>
          {row.title}
        </Link>
      )
      // sortable: true
            ...
            >
              ...
              <div className="flex items-center">
                ...
                >
                  ...
                  <Option value="true" children={<p>Active</p>}>
                    Active
                  </Option>
                  <Option value="false" children={<p>Deleted</p>}>
                    Deleted
                  </Option>
                </Select>
              </div>
