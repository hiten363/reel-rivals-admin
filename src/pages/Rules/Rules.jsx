...
import AddRulesModal from './Modals/AddRulesModal';
import EditRulesModal from './Modals/EditRulesModal';
...
const Rules = ({ notify }) => {
      ...
      selector: row => <div className="flex justify-center">
        ...
        {/* <div onClick={async () => {
          if (row.status === "true") {
            ...
            let ans = await undoRules({ id: row._id });
            if (ans.status) {
              notify('success', 'Rules recovered successfully');
  ...
  //   console.log(id);
  //   const ans = await deleteRules(id);
  ...
  return (
    <>
      <AddRulesModal setRefreshFlag={setRefreshFlag} refreshFlag={refreshFlag} notify={notify} />
      <EditRulesModal flag={flag} data={data1} setRefreshFlag={setRefreshFlag} refreshFlag={refreshFlag} notify={notify} />
            ...
            <div className="flex items-center justify-between">
              ...
              {data.length > 0 ? <Button color="red" onClick={() => {
                ...
                Edit</Button> : <Button color="red" onClick={() => {
                  document.getElementById('addRulesModal').classList.toggle('hidden');
