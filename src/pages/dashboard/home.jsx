...
import { TicketIcon, UsersIcon, ChartBarIcon, InboxStackIcon, ClockIcon } from "@heroicons/react/24/solid";
  ...
  return (
    <div className="mt-12">
      <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        <StatisticsCard
          color='gray'
          value={!loadFlag ? dashboardData?.users ? dashboardData?.users : 0 : 'Loading ..'}
          title={'Users'}
        ...
        {/* <StatisticsCard
          color='gray'
          value={!loadFlag ? dashboardData?.subscriptions ? dashboardData?.subscriptions : 0 : 'Loading ..'}
          title={'Payment Plans'}
          icon={React.createElement(InboxStackIcon, {
            className: "w-6 h-6 text-white"
          })}
        />
        <StatisticsCard
          color='gray'
          value={!loadFlag ? dashboardData?.payments ? (dashboardData?.payments+' ₹') : '0 ₹' : 'Loading ..'} 
          title={'Total Sales'}
        ...
        <StatisticsCard
          color='gray'
          value={!loadFlag ? dashboardData?.recentPayments ? (dashboardData?.recentPayments+' ₹') : '0 ₹' : 'Loading ..'} 
          title={'Current Event Sales'}
          icon={React.createElement(ChartBarIcon, {
            className: "w-6 h-6 text-white"
          })}
        /> */}
